...
export function confirmServiceForceUpdate(message: string, callback: PromptCallback) {
...
function customizePrompt(box: JQuery<HTMLElement>, message: string, toggleCheckbox: boolean) {
